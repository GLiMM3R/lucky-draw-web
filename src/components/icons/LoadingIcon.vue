<template>
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
        style="margin: auto; display: block; shape-rendering: auto;" :width="props.width" :height="props.height"
        :style="[`background: ${props.bgColor};`]" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
        <circle cx="84" cy="50" r="10" fill="#028947">
            ...
            <animate attributeName="fill" repeatCount="indefinite" dur="1s" calcMode="discrete" keyTimes="0;0.25;0.5;0.75;1"
                values="#028947;#028947;#b3e46e;#94d137;#028947" begin="0s"></animate>
        </circle>
        <circle cx="16" cy="50" r="10" fill="#028947">
        ...
        <circle cx="50" cy="50" r="10" fill="#94d137">
            <animate attributeName="r" repeatCount="indefinite" dur="1s" calcMode="spline" keyTimes="0;0.25;0.5;0.75;1"
        ...
        <circle cx="84" cy="50" r="10" fill="#b3e46e">
            <animate attributeName="r" repeatCount="indefinite" dur="1s" calcMode="spline" keyTimes="0;0.25;0.5;0.75;1"
...
const props = defineProps(['bgColor', 'width', 'height'])
</script>